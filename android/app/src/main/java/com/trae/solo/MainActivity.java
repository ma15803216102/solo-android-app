            ...
            if (bridge != null) {
                ...
                if (webView != null) {
                    String js = "window.__SOLO_APP_VERSION__=" + "'" + getAppVersionName() + "'" + ";" +
                             ...
                             "if(typeof window._traeVConsoleEnabled!=='boolean'){try{window._traeVConsoleEnabled=(localStorage.getItem(VC_KEY)||'1')!=='0';}catch(e){window._traeVConsoleEnabled=true;}}\n" +
