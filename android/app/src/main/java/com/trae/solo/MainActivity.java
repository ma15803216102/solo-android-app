            ...
            if (bridge != null) {
                ...
                if (webView != null) {
                    String js = "if(!window._traeNotifierInjected){" +
                            ...
                            "let sx,sy,ix,iy,moved=false;" +
                            "m.addEventListener('touchstart',e=>{" +
                            "  let t=e.touches[0];sx=t.clientX;sy=t.clientY;" +
                            "  let r=c.getBoundingClientRect();ix=r.left;iy=r.top;" +
                            ...
                            "    let ml=window.innerWidth-c.offsetWidth,mt=window.innerHeight-c.offsetHeight;" +
                            ...
                            "  if(!moved)c.classList.toggle('exp');" +
                            "  else{" +
                            "    let r=c.getBoundingClientRect();let cx=r.left+r.width/2;" +
                            "    let sl=cx<window.innerWidth/2?10:window.innerWidth-r.width-10;" +
                            "    c.style.left=sl+'px';c.classList.remove('exp');" +
                            "  }" +
                            "});" +
